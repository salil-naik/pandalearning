...
<div class="container">
	...
	<div class="text-area">
		...
		<h3 style="color: #48af4b;">BackEnd <br><span style="font-weight: 100;">Development</span></h3>
	...
	<div class="row">
				<div class="col s12 m6 " >
					<div class="card-panel cust-card" style="border-radius: 15px; margin-left: 38px; padding-bottom: 50px;">
						<div class="cir" style="float:left;" >
							<img src="images/php.png" class="cir-icon"
							style="align-items: center;">
						</div>

						<h4 style="	position: relative;left: -45px;">PHP <br><span style="font-weight: 200;">Basic to Advanced</span> </h4>
				...
				<div class="col s12 m6 " >
					<div class="card-panel cust-card" style="border-radius: 15px; margin-left: 38px; padding-bottom: 50px;">
						<div class="cir" style="float:left;" >
							<img src="images/pythonnew.png" class="cir-icon"
							style="align-items: center;">
						</div>
						<h4 style="	position: relative;left: -45px;" >Python <br><span style="font-weight: 200;">Basic to Advanced</span> </h4>
				...
				<div class="col s12 m6 " >
					<div class="card-panel cust-card" style="border-radius: 15px; margin-left: 38px; padding-bottom: 50px;">
						...
						<h4 style="	position: relative;left: -45px;">Ruby on Rails <br><span style="font-weight: 200;">Basic to Advanced</span> </h4>
